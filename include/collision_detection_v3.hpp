...
/*void draw_shapes(std::vector<Polygon> poly_list, float x, 
              float y, float theta, std::vector<std::pair<int,Polygon>> victim_list,
              img_map_def map_param){
                 arc_extract line1[2];
                 //line 1
                 line1[0].start_point = Point (Ax, Ay);
                 line1[0].end_point = Point (Bx, By);
                 line1[0].LSR = 2;
                 //line 2
                 line1[1].start_point = Point (Cx, Cy);
                 line1[1].end_point = Point (Dx, Dy);
                 line1[1].LSR = 0;
              }*/
/*int main()
{
